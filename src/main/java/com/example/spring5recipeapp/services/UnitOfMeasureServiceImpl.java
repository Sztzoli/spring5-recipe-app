...
public class UnitOfMeasureServiceImpl implements UnitOfMeasureService {
    ...
    private final UnitOfMeasureToUnitMeasureCommand unitOfMeasureToUnitOfMeasureCommand;

    public UnitOfMeasureServiceImpl(UnitOfMeasureRepository unitOfMeasureRepository, UnitOfMeasureToUnitMeasureCommand unitOfMeasureToUnitOfMeasureCommand) {
